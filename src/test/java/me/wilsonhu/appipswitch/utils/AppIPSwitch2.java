 ...
 * @author user
 */
public class AppIPSwitch2 extends javax.swing.JFrame {
     ...
     */
    public AppIPSwitch2() throws URISyntaxException {
    ...
    private void btnRunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRunActionPerformed
        ...
        try {
            ...
            Logger.getLogger(AppIPSwitch2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppIPSwitch2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new AppIPSwitch2().setVisible(true);
